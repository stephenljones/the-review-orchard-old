import csv, sys
sys.stdout = open('html-links.txt' , 'w')

#Add each category to a dictionary key and links to the value for that key
links_dict = {}
for row in csv.reader(open('csv-links.csv'),delimiter=","):
	category = row[3]
	...
	if category == "Apple":
		...
		title = row[0] + ' ' + row[1]
		links_dict[key].append("<a href=" + '"' + row[2] + '"' + " class=\"link-text\">" + title.strip() + '</a>')
...
print("<!------------------------------------->")
print("<!------------SECOND COLUMN------------>")
print("<!----------VIDEO REVIEW LINKS--------->")
print("<!------------------------------------->")
print('<h2 class="category-text">Video Reviews</h2>')
for key, links in links_dict.items():
	if key == 'Video':
			for a_tag in links:
				print(a_tag)
...
#GENERAL REVIEW
print("<!------------------------------------->")
print("<!---------GENERAL REVIEW LINKS-------->")
print("<!------------------------------------->")
print('<h2 class="category-text">General Reviews</h2>')
for key, links in links_dict.items():
	if key == 'General Review':
			for a_tag in links:
				print(a_tag)
print("<!------------------------------------->")
print("\n")
